            ...
            <form action="clientsEdit.php" method="get">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="teises_id">
                        <option value="0" <?php echo $select_array[0]; ?>>Naujas klientas</option>
                        <option value="1" <?php echo $select_array[1]; ?>>Ilgalaikis klientas</option>
                        ...
                        <option value="4" <?php echo $select_array[0]; ?>>Uzsienio(Ne EU) klientas</option>
