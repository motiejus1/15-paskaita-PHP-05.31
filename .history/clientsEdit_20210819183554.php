            ...
            <form action="clientsEdit.php" method="get">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="teises_id">
                        <option value="0" selected='false'>Naujas klientas</option>
                        <option value="1" selected='false'>Ilgalaikis klientas</option>
                        <option value="2" selected='false'>Neaktyvus klientas</option>
                        <option value="3" selected='false'>Nemokus klientas</option>
                        <option value="4" selected='false'>Uzsienio(Ne EU) klientas</option>
                        <option value="5" selected='false'>Uzsienio(EU) klientas</option>
                    </select>
                </div>
