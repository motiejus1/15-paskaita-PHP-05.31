...
<table class="table table-striped">
  ...
  <tbody>
    ...
    $sql = "SELECT klientai.ID, klientai.vardas, klientai.pavarde, klientai_teises.pavadinimas FROM klientai LEFT JOIN klientai_teises ON klientai_teises.reiksme = klientai.teises_id WHERE 1 ORDER BY klientai.ID DESC"
    ...
    while($clients = mysqli_fetch_array($result)) {
        echo "<tr>";
            ...
            //ifa/switch
                ...
                $sql = "SELECT * FROM klientai_teises WHERE reiksme = $teises_id";//417 uzklausa
