...
<body>
    <div class="container">
        ...
        <?php 
        //Imoniu atvaizdavima
            $sql = "SELECT imones.ID, imones.pavadinimas AS imones_pavadinimas, imones.aprasymas AS imones_aprasymas, imones_tipas.pavadinimas AS tipo_pavadinimas, imones_tipas.aprasymas AS tipo_aprasymas FROM `imones` LEFT JOIN imones_tipas ON imones.tipas_ID = imones_tipas.ID WHERE 1
            ";
            ...
            while($companies = mysqli_fetch_array($result)) {
                echo "<tr>";
                    ...
                    echo "<td>". $companies["aprasymas"]."</td>";
                    // echo "<td>". $companies["pavadinimas"]."</td>";
