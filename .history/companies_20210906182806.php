...
<body>
    <div class="container">
        ...
        <?php 
        //Imoniu atvaizdavima
            $sql = "SELECT imones.ID, imones.pavadinimas, imones.aprasymas, imones_tipas.pavadinimas, 
            imones_tipas.aprasymas 
            FROM `imones` 
            ...
            while($companies = mysqli_fetch_array($result)) {
                echo "<tr>";
                    ...
                    echo "<td>". $companies["vardas"]."</td>";
                    echo "<td>". $companies["pavarde"]."</td>";
