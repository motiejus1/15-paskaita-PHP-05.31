...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <select class="form-control" name="rikiuoti_pagal">
            <option value="klientai.ID">ID</option>
            <option value="klientai.vardas">Kliento vardas</option>
            <option value="klientai.pavarde">Kliento pavardė</option>
            <option value="">Kliento teisės</option>
        </select>
